namespace Grammar.English.Test.Integration.Resources
{
    static class BlazonRepository
    {
        ...
        #region british history https://www.british-history.ac.uk/rchme/london/vol2/pp149-150

        public const string Boleyn_Anne = "quarterly of six. 1. England with a label of France, for Lancaster. 2. Old France with a label gules, for Angoulême. 3. Gules a leopard or for Guienne. 4. Or a chief indented azure for Butler quartering argent a lion sable crowned gules for Rochfort. 5. England with a label argent for Brotherton. 6. Checky or and azure for Warenne.";
        public const string Bonner = "quarterly gules and sable a mill-rind cross quarterly or and ermines and a chief or charged with a rayed rose between two pelicans gules.";
        public const string Botyll = "gules a cheveron or between three combs argent.";
        public const string Brooke = "or a cross engrailed and parted gules and sable.";
        public const string Brotherton = "England differenced with a label argent.";
        public const string Broughton = "argent a cheveron between three molets gules.";
        public const string Carleon = "sable a roundel between three castles argent.";
        public const string Cecil = "barry of ten argent and azure six scutcheons sable each charged with a lion argent.";
        public const string Clere = "argent a fesse azure charged with three eagles or";
        public const string Cleves_Anneof = "quarterly of seven. 1. Gules a charbocle or surmounted by a scutcheon argent for Duchy of Cleves. 2. Or a lion sable for Duchy of Jülich. 3. Argent a lion gules crowned azure for Duchy of Berg. 4. Argent a lion azure crowned or for Duchy of Veldenz. 5. Or a fesse checky argent and gules for County of Mark. 6. Azure a leopard rampant argent for County of Schleiden. 7. Argent three cheverons gules for County of Ravensberg.";
        public const string Colte = "argent a fesse azure between three galloping colts sable.";
        public const string DAubusson = "... a mill-rind cross...";
        public const string Deman = "... a cheveron between three Moors' heads...";
        public const string DesVanders = "see Vanders, des, below.";
        public const string Docwra = "sable a cheveron engrailed between three roundels argent with a pale gules upon each roundel.";
        public const string Draycot = "argent a cross engrailed sable with an eagle gules in the quarter.";
        public const string Drew = "ermine a lion passant gules.";
        public const string EdwardtheConfessor = "azure a cross paty between five martlets or.";
        public const string Ely_Seeof = "gules three crowns or.";
        public const string Fitzjames = "azure a dolphin argent quartered with Draycot, q.v.";
        public const string Fletcher = "sable a cross paty between four scallops argent.";
        public const string Fowler = "azure a cheveron argent between three herons or with three crosses paty gules on the cheveron.";
        public const string France = "azure three fleurs-de-lis or.";
        public const string Grey = "barry argent and azure with three roundels gules in the chief.";
        public const string Hastings = "or a sleeve gules.";
        public const string Holand = "England differenced with a border of France.";
        public const string Hornebolt = "... a cheveron ... between three martlets ... with a scutcheon ... on the cheveron charged with a mill-rind cross ... between four crescents ...";
        public const string Howard = "gules a bend between six crosslets fitchy argent with the Flodden augmentation on the bend.";
        public const string Howard_Katherine = "quarterly. 1. Azure three fleurs-de-lis in pale or between two flaunches ermine each charged with a rose gules. 2. Brotherton. 3. Gules a bend between six crosslets fitchy argent with the augmentation for Flodden upon the bend. 4. Azure two leopards or between four halves of fleurs-de-lis or touching the edges of the quarter.";
        public const string JohnofJerusalem_OrderofSt = "gules a cross argent.";
        public const string Kemp = "gules three sheaves and a border engrailed or.";
        public const string Lacy = "or a lion purpure.";
        public const string London_Seeof = "gules two crossed swords of St. Paul with their blades argent and hilts and pommels or.";
        public const string Lovell1550 = "argent a cheveron azure between three squirrels gules.";
        public const string Manny = "or three cheverons sable.";
        public const string Mompesson = "argent a lion sable charged on the shoulder with a pinson (or chaffinch) or.";
        public const string Montagu = "argent a fesse indented of three points gules.";
        public const string Monthermer = "or an eagle vert.";
        public const string More_SirThomas = "argent a cheveron engrailed between three moor-cocks sable having beaks, combs and legs gules, quartered with argent a cheveron between three unicorns' heads razed sable with three bezants on the cheveron.";
        public const string Mowbray = "gules a lion argent.";
        public const string Muswell = "vert two cheverons argent with three cinqfoils gules upon each.";
        public const string Parker = "argent a cheveron between three harts' heads cabossed gules.";
        public const string Pever = "argent a cheveron gules charged with three fleurs-de-lis argent.";
        public const string Peyntwyn = "gules three thistles or with their leaves vert.";
        public const string Savage = "argent a pale indented sable.";
        public const string Savill = "argent a bend sable with three owls argent thereon.";
        public const string Stafford1550 = "or a cheveron gules.";
        public const string Tunstall = "sable three combs argent.";
        public const string Uvedale = "argent a mill-rind cross gules.";
        public const string Valence = "burely argent azure an orle of martlets gules.";
        public const string Vanders_des = " ... a winnowing-fan ... with a molet of six points ... in the chief.";
        public const string Warenne = "checky or and azure.";
        public const string West = "argent a cheveron sable between three roses gules seeded stalked and leaved proper.";
        public const string Whorwood = "argent a cheveron between three harts' heads cabossed sable.";
        public const string Wolsey = "sable a cross engrailed argent charged with a lion passant gules between four leopards' heads azure and a chief or with a rose gules between two Cornish choughs therein.";
        public const string Wyatt = "party fessewise gules and azure a horse-barnacle argent.";
        public const string Yong = "lozengy argent and vert a cheveron azure with three bezants thereon and a chief gules charged with a goat's head razed between two scallops or.";
        public const string York_Seeof = "gules two crossed keys argent and in the chief the triple crown or of St. Peter.";

        #endregion

        #region

        public const string Sysoyn = "Bendy of six or and azure";
        public const string Heyne = "Argent, a bordure gules";
        public const string Pamele = "Barry of six gules and or";
        public const string BoullersBoulare = "Or, an inescutcheon gules";
        public const string Audenaerde = "Barry of six or and gules";
        public const string Bevre = "Barry of eight or and azure, a saltire gules";
        public const string Bevre2 = "Barry of six or and azure, in chief three annulets gules";
        public const string RoustineBoulare = "Or, an inescutcheon gules overall a bendlet vert";
        public const string Audenaerde2 = "Barry of six gules and or, a lion rampant sable";
        public const string DixmudeBevre = "Barry of eight or and azure, a saltire gules";
        public const string BernageBevre = "Barry of six gules fretty argent, and or";
        public const string BellettesDeJonge = "Barry of eight argent and azure";
        public const string GemellesVieville = "Barry of six or and azure, in chief three annulets gules";
        public const string Steelant = "Gules, a fess argent fretty gules";
        public const string LophemSteelant = "Gules, a fess argent fretty gules, in chief three spur-rowels or";
        public const string CornhuseSteelant = "Gules, a fess argent fretty gules, in chief three martlets argent";
        public const string PerboomeSteelant = "Gules, a fess argent fretty gules, in chief three plates";
        public const string WolfsbergeSteelant = "Gules, a fess argent fretty gules";
        public const string PerarkeSteelant = "Gules, a fess argent fretty gules";
        public const string Harleke = "Gyronny of ten azure and argent, an inescutcheon gules";
        public const string Harlebeke = "Argent, a chevron gules";
        public const string Courtray = "Argent, a chevron within a bordure wavy gules";
        public const string DudzeleHarlebeke = "Argent, a chevron gules";
        public const string Nevers = "Or, a lion rampant sable, armed and langued, overall a label gules";
        public const string DrinchemFlandres = "Gules, a chevron ermine between a quarter or charged with a lion rampant sable armed and langued gules, an inescutcheon barry of eight argent and azure charged with a lion rampant gules, and a duck statant argent";
        public const string NamuersFlandres = "Or, a lion rampant sable, armed and langued, debruised by a bendlet invected-counter invected gules";
        public const string LodryckFlandres = "Or, a lion rampant sable, armed and langued, overall a label gules";
        public const string DendremondeFlandres = "Or, a lion rampant sable, armed and langued, debruised by a bendlet gules";
        public const string MelleFlandres = "Or, a lion rampant sable, armed and langued, debruised by a bendlet invected-counter invected gules";
        public const string LescluseNamurdeFlandres = "Or, a lion rampant sable, armed and langued, debruised by a bendlet invected-counter invected gules";
        public const string GuydeFlandres = "Or, a lion rampant sable, armed and langued, debruised by a scarpe gules";
        public const string YwendeFlandres = "Gules, on a quarter or a lion rampant sable, armed and langued gules";
        public const string RuffelaertdeFlandres = "Argent, a fur hat gules, on a quarter or a lion rampant sable, armed and langued gules";
        public const string HaseedeFlandres = "Argent, on a quarter or a lion rampant sable, armed and langued gules";
        public const string RuffelaertdeFlandres2 = "Argent, on a quarter or a lion rampant sable, armed and langued debruised by a scarpe gules";
        public const string PraetFlandres = "Gules, a chevron ermine between in chief a quarter or charged with a lion rampant sable armed and langued gules, and an inescutcheon barry of eight argent and azure charged with a lion rampant gules";
        public const string OnneleetBevreFlandres = "Quarterly, or a lion rampant sable, armed and langued gules, and barry of eight argent and azure, a lion rampant gules, an inescutcheon gules charged with a chevron ermine";
        public const string Gavere = "Or, a double tressure flory-counter-flory vert";
        public const string Gavere4 = "Or, a double tressure flory-counter-flory vert, overall a bend gules";
        public const string Gavere2 = "Or, three lions rampant gules";
        public const string Gavere3 = "Gules, three lions rampant argent crowned or";
        public const string EscornesetGavere = "Or, a double tressure flory-counter-flory vert, overall a chevron gules";
        public const string Lykerke = "Gules, three lions rampant or";
        public const string HersellesGavere = "Gules, three lions rampant argent within a bordure ermine";
        public const string CheuaeyGavere = "Gules, three lions rampant argent crowned or";
        public const string IngelmonstreGhistelles = "Gules, a chevron ermine";
        public const string Ghistelles = "Gules, a chevron ermine";
        public const string Ghistelles2 = "Gules, a chevron or";
        public const string DudzelleGhistelles = "Quarterly gules, a chevron ermine, and argent, a chevron gules";
        public const string WouterdeGhistelles = "Gules, a chevron ermine between three mullets of eight pierced argent";
        public const string BevreetHusselghemGhistelles = "Quarterly gules, a chevron ermine, and barry of eight argent and azure, a lion rampant gules";
        public const string LakeGhistelles = "Gules, a chevron ermine and in sinister chief an escutcheon azure, charged with a lion rampant or";
        public const string MoereGhistelles = "Gules, a chevron ermine and in dexter chief an escutcheon barry of eight argent and azure charged with a lion rampant gules";
        public const string GeelueGhistelles = "Gules, a chevron ermine between three crosses [flory without the center point] argent";
        public const string Halewin = "Argent, three lions rampant sable armed or";
        public const string RosebekeHalewin = "Argent, three lions rampant sable armed or, a bend compony or and gules";
        public const string HutkerkeHalewin = "Argent, an inescutcheon argent charged with a cross sable bezanty between three lions rampant sable armed or";
        public const string BasseveldeHalewin = "Argent, three lions rampant sable armed or";
        public const string BuggenhoutHalewin = "Argent, an inescutcheon azure charged with a fess or between three lions rampant sable armed or";
        public const string VesteHalewin = "Argent, three lions rampant sable armed or";
        public const string WellecommeHalewin = "Argent, three lions rampant sable armed or within a bordure compony azure and or";
        public const string ZuevezelleHalewin = "Argent, an inescutcheon per fess ermine and azure between three lions rampant sable armed or ";
        public const string DixmudeAveskercke = "Or, a fess gules";
        public const string Averskercke = "Or, a fess gules";
        public const string VateneAveskercke = "Or, a fess gules and in chief three martlets sable";
        public const string WaemerAveskercke = "Or, a fess gules and in chief a label azure";
        public const string LamaersAveskercke = "Or, a fess gules";
        public const string SteenbekeAveskercke = "Per fess or and argent, a fess gules within a bordure wavy azure";
        public const string Wavrin = "Azure, an inescutcheon argent";
        public const string WoestineWavrin = "Azure, an inescutcheon argent and a label of five points or";
        public const string WasieresWavrin = "Azure, an inescutcheon argent and a label of three points gules";
        public const string WaestresWavrin = "Azure, an inescutcheon argent overall a bend gules";
        public const string WoestineWavrin2 = "Azure, an inescutcheon argent and a label of six points or";
        public const string GancourtWavrin = "Azure, an inescutcheon argent and a label of three points sable, each point charged with a plate";
        public const string HassencourtWavrin = "Azure, an inescutcheon argent overall a bend compony argent and gules";
        public const string HoyeWavrin = "Azure, an inescutcheon argent and in chief three martlets or";
        public const string Pouckes = "Or, a lion passant guardant sable armed, orbed and langued gules";
        public const string HouplinesPouckes = "Or, a lion passant guardant sable armed, orbed and langued gules, charged on the breast with an estoile argent";
        public const string CommePouckes = "Or, a lion passant guardant sable armed, orbed langued, and crowned gules";
        public const string WinghenePouckes = "Or, a lion passant guardant sable armed, orbed and langued gules, crowned argent";
        public const string RonnePouckes = "Per pale or and vert, a lion passant guardant sable armed, orbed and langued gules";
        public const string Pouckes2 = "Or, a lion passant guardant sable armed, orbed and langued gules";
        public const string LavaysPouckes = "Or, a lion passant guardant sable armed, orbed and langued or within a bordure gules";
        public const string LavaysPouckes2 = "Or, a lion passant guardant sable armed, orbed and langued or within a bordure gules";
        public const string Rode = "Azure, a lion rampant or crowned argent (Rode)";
        public const string MassemineRode = "Azure, a lion rampant or";
        public const string GarlandeRode = "Azure, a lion rampant or";
        public const string SantvoordedeGand = "Or, a chevron sable";
        public const string BriestedeVilain_Gand = "Per fess argent and sable, a demi-lion gules issuing from the line of division";
        public const string AexpoeleGand = "Per fess argent and sable, in chief a barrulet dancetty gules";
        public const string AernoutleFrisonGand = "Per fess argent and sable, in chief three martlets azure";
        public const string St = "Per fess argent and sable";
        public const string GhistellesLuxenbourg = "Argent, a lion rampant queue-fourche gules armed, langued, and crowned or, a label azure";
        public const string Rode_St = "Argent, a lion rampant queue-fourche gules, armed, langued, and crowned or";
        public const string Fienes_Gavre_etZottenghienLuxenbourg = "Quarterly, argent, a lion rampant que ue-fourche gules armed, langued, and crowned or, and gules, a mullet of ten points argent";
        public const string FrenesetVianeLuxenbourg = "Argent, a lion rampant gules armed, langued, and crowned or, a label azure";
        public const string ColscampLichtervelde = "Per fess ermine and azure, in base a dove volant argent";
        public const string HautvivreLichtervelde = "Per fess ermine and azure, a bordure wavy gules";
        public const string Lichtervelde = "Per fess ermine and azure";
        public const string StadeLichtervelde = "Per fess ermine and azure";
        public const string GruthuseBruges = "Or, a cross sable";
        public const string GruthuseGramsberge = "Quarterly, or a cross sable, and gules a saltire argent";
        public const string Guise = "Argent, a fess gules";
        public const string LembekeGuise = "Argent, a fess gules";
        public const string Guise2 = "Barry of six argent and gules";
        public const string Heyle = "Per fess argent and gules";
        public const string Heyle2 = "Gules, a cross between twelve martlets argent";
        public const string BoysHeyle = "Gules, a cross between twelve martlets argent";
        public const string Hueele = "Per fess paly of seven gules and argent, and or";
        public const string LichterveldeHueele = "Per fess paly of seven gules and argent, and or";
        public const string noname = "Argent, a sword [hilt to base] gules";
        public const string Aloist = "Gules fretty argent";
        public const string Asselt = "Or billettty, a lion rampant gules armed and langued argent";
        public const string VyaneHasselt = "Or billettty, a lion rampant gules armed and langued argent";
        public const string Avelingham = "Gules, a cross [flory without the center points] argent";
        public const string Avelinge = "Chevronelly of eight argent and gules";
        public const string EveldingeBourgoingne = "Quarterly: In 1 and 4, France within a bordure compony argent and gules, in 2 per pale bendy azure and or within a bordure gules and sable a lion rampant or, in 3 per pale bendy azure and or within a bordure gules and argent a lion rampant gules, on an inescutcheon or a lion rampant sable armed and langued gules, overall a scarpe gules";
        public const string SomerdicBourgoingne = "Or, a chevron divided per pale and per chevron: in 1 and 4, azure, six fleurs de lys or within a bordure compony argent and gules, in 2 per pale bendy azure and or within a bordure gules and sable a lion rampant or, in 3 per pale bendy azure and or within a bordure gules and argent a lion rampant gules, on an inescutcheon or a lion rampant sable armed and langued gules";
        public const string WackeneBourgoinge = "Quarterly: In 1 and 4, France within a bordure compony argent and gules, in 2 per pale bendy azure and or within a bordure gules and sable a lion rampant or, in 3 per pale bendy azure and or within a bordure gules and argent a lion rampant gules, on an inescutcheon or a lion rampant sable armed and langued gules, a chief or";
        public const string BevreBourgoingne = "Quarterly: in 1 and 4, quarterly in 1 and 4, France within a bordure compony argent and gules, in 2 per pale bendy azure and or within a bordure gules and sable a lion rampant or, in 3 per pale bendy azure and or within a bordure gules and argent a lion rampant gules, on an inescutcheon or a lion rampant sable armed and langued gules; in 2 and 3 barry of six or and azure, in chief three annulets gules";
        public const string WoestineBourgoingne = "Or, a bend divided per saltire: in 1 and 4, azure, six fleurs de lys or within a bordure compony argent and gules, in 2 per pale bendy azure and or within a bordure gules and sable a lion rampant or, in 3 per pale bendy azure and or within a bordure gules and argent a lion rampant gules, on an inescutcheon or a lion rampant sable armed and langued gules";
        public const string Courteraisiens = "Argent, three chevronels gules";
        public const string Corteraisiens = "Argent, a lion rampant argent outlined sable, overall three chevronels gules";
        public const string MelleCourteraisien = "Or, four chevronels gules";
        public const string LessegersCourteroysin = "Or, four chevronels gules within a bordure wavy azure";
        public const string Koukelare = "Azure, three plates";
        public const string LechtegemKoukelare = "Azure, three plates";
        public const string HernegemKoukelare = "Azure, a spur-rowel argent between three plates";
        public const string HaertryckeKoukelare = "Azure, an ewer or between three plates";
        public const string BouwenkerkeKoukelare = "Azure semy of cross-crosslets argent, three plates";
        public const string PuthemClaerhout = "Per fess argent and sable, two mullets of eight gules pierced sable";
        public const string Claerhout = "Per fess argent and sable, two mullets of eight gules pierced sable";
        public const string HardoyeClaerhout = "Per fess argent and sable, two mullets of eight gules pierced sable";
        public const string Puthem_Coelscamp_etHassebrouchClaerhout = "Per fess ermine and azure";
        public const string HardoyeClaerhout2 = "Per fess ermine and azure, in base an escutcheon checky or and gules";
        public const string Douay = "Per fess ermine and vert";
        public const string OrbicycoertDoway = "Per fess ermine and vert, a bordure wavy gules";
        public const string FremicourtDoway = "Per fess ermine and vert, a bordure gules";
        public const string desFosses = "Argent, an inescutcheon and in chief three martlets gules";
        public const string desFosses2 = "Argent, a chevron gules between three martlets sable";
        public const string HueeledesFosses = "Argent, a chevron gules between three martlets sable";
        public const string LovendegemdesFosses = "Argent, a chevron gules between three martlets sable";
        public const string MeltselledesFosses = "Argent, a chevron gules between three martlets sable";
        public const string SchardauwedesFosses = "Argent, a chevron gules between three martlets sable, a bordure wavy gules";
        public const string HayshoveWalle = "Gules, a lion rampant crowned or";
        public const string Walle = "Gules, ten mascles 3,3,3, and 1 conjoined argent";
        public const string Walle2 = "Argent, a chevron between three martlets sable";
        public const string DouveWalle = "Quarterly, argent a chevron between three martlets sable, and or, a cross formy gules, overall an inescutcheon or charged with three chevrons sable";
        public const string Wendine = "Gules, a saltire argent";
        public const string HunbergeWendine = "Gules, a saltire argent charged with a mullet of eight pierced sable";
        public const string Winnendale = "Gyronny of eight or and azure, an inescutcheon gules, on a chief or a lion passant sable armed and langued gules";
        public const string Comines = "Or, a key wards to chief gules between six torteau 2,2 and 2";
        public const string Comines2 = "Or, an inescutcheon gules charged with a cross azure billetty or; between seven roses gules seeded argent, barbed vert";
        public const string JehanBonin = "Or, three garbs [or really ugly millrinds] sable";
        public const string MolenbekeBonin = "Or, a saltire invected-counter-invected azure between four garbs sable";
        public const string BevreEscornes = "Or, a tressure flory-counter-flory vert, overall a chevron gules";
        public const string MolenbequeEscornes = "Or, a tressure flory-counter-flory vert, overall a chevron gules";
        public const string Bernhem = "Azure, three bulls statant or, a chief paly of six argent and gules";
        public const string Bernhem2 = "Azure semy-de-lys or, a chief paly of seven or and gules";
        public const string Furnes = "Ermine, a bend of seven lozenges gules";
        public const string HontscoteFurnes = "Ermine, on a bend gules three escallops or";
        public const string Lannoy = "Argent, three lions vert armed and langued or";
        public const string TronchienesLannoy = "Argent, three lions vert armed and langued or within a bordure wavy gules";
        public const string Leewergem = "Azure billetty, a lion rampant or";
        public const string Leewergem2 = "Azure, a lion rampant or armed gules";
        public const string Landas = "Per pale indented argent and gules";
        public const string Landas2 = "Per pale indented argent and sable Hagron (Landas)";
        public const string EspinoyMelun = "Azure, seven bezants 3,3, and 1, a chief or";
        public const string EspinoydAntoingMelun = "Azure, seven bezants 3,3, and 1, a chief or";
        public const string Moerkerke = "Or, on a saltire gules five escallops palewise argent";
        public const string MerwedeMoerkerke = "Or, on a saltire gules five escallops palewise argent";
        public const string MeeringhemMoerkerke = "Or, on a saltire gules five escallops palewise within a bordure argent";
        public const string MoraymezMortaingne = "Or, on a cross gules five escallops argent";
        public const string MontagleMortaingne = "Or, a cross gules within a bordure wavy argent";
        public const string Menyn = "Gules, a double headed eagle displayed argent";
        public const string MenynetMuenicxzee = "Argent, three chevrons gules";
        public const string Maestede = "Ermine, a fess azure overall a saltire gules";
        public const string Moerseke = "Argent, a fess azure overall a saltire gules";
        public const string Lyntvrame = "Per fess gules and argent";
        public const string BoutgaleLyntvrame = "Per fess gules and argent, in canton a martlet argent";
        public const string Lissewege = "Checky azure and argent, a quarter or charged with four chevrons gules";
        public const string Lysseweege = "Per fess gules and argent";
        public const string ExaerdeLykerke = "Gules, three lions rampant or";
        public const string HerselleLykerke = "Gules, three lions rampant or";
        public const string MelleMontmorency = "Or, a cross gules between sixteen eagles displayed azure";
        public const string CoukelareetlaChapelleMontmorency = "Or, on a cross gules between sixteen eagles displayed azure, a lozenge argent";
        public const string Mayres = "Sable billetty, a chevron argent";
        public const string Mayres2 = "Sable billetty, a saltire argent";
        public const string Meedtkerke = "Gules, two swords hilts to chief crossed in saltire proper";
        public const string MarkeMeedtkerke = "Gules, two swords hilts to chief crossed in saltire proper";
        public const string HamshoveMastain = "Gules, on a fess or a mullet of eight azure, in chief a barrulet dancetty or";
        public const string MasminesMastain = "Gules, a fess and in chief a barrulet dancetty or";
        public const string Maldeghemlaloyale = "Or, a cross between twelve martlets in orle gules";
        public const string PoeleMaeldegem = "Or, on a cross between twleve martlets in orle gules, five escallops or";
        public const string Gogaucourt = "Ermine, a label of three points gules";
        public const string Gogaucourt2 = "Gules, a fess ermine";
        public const string Houchem = "Argent, a lion rampant gules armed langued and crowned or debruised by a bend azure charged with three hammers or";
        public const string Houchem2 = "Argent billetty, a lion rampant sable armed orbed and langued gules";
        public const string Isendicke = "Vairy argent and sable";
        public const string Isendicke2 = "Sable, a cross between twelve martlets argent";
        public const string Imbiese = "Bendy or and azure, a bordure gules";
        public const string OverbrakeleImbiese = "Or, a lion rampant or outlined sable, debruised by three bends azure, a bordure gules";
        public const string LandeghemHemsrode = "Or, on a chevron gules, in base a ewer to sinister, three annulets within a bordure argent";
        public const string Hemsrode = "Or, on a chevron gules three annulets argent";
        public const string Hoverdrie = "Argent, a fess sable";
        public const string Hoverdrie2 = "Gules, a lion rampant argent armed and langued or, a label of three points azure";
        public const string Berst = "Checky or and sable, a bordure wavy argent";
        public const string Berst2 = "Chevronelly azure and or, a quarter argent charged with a mullet of eight gules";
        public const string DunkerkeBruges = "Or, a cross sable and a label of five points azure";
        public const string EspireBruges = "Quarterly: Or, a cross sable and gules, a saltire argent";
        public const string Bouchout = "Argent, a cross gules and a bordure wavy or";
        public const string BoullersBouchout = "Argent, a cross gules";
        public const string Blasvelt = "Argent, three fish [heads to chief] sable";
        public const string SantesBlasvelt = "Argent, three fish [heads to chief] sable";
        public const string StGeorgesBaenst = "Sable, a fess and in chief three martlets argent";
        public const string MelysantetGapinghesBaenstOestkerke = "Sable, a fess and in chief three martlets argent, the center bird maintaining a buckle or in its beak";
        public const string Oestcamp = "Gules, a bend between six martlets argent";
        public const string CominesClyte = "Gules, a chevron or between three escallops argent within a bordure or";
        public const string Clyte = "Gules, a chevron between three escallops or within a bordure azure";
        public const string Ruwerschuere = "Gules, a chevron or between three escallops argent within a bordure compony gules and or";
        public const string StPierceDudzelle = "Barry argent and azure, a quarter argent charged with a chevron gules";
        public const string BuekemareDudzelle = "Argent, on a chevron gules three escallops or";
        public const string Praet = "Gules, three eagles displayed or";
        public const string Praet2 = "Or, on a saltire gules nine eagles displayed or";
        public const string Praet3 = "Or, a saltire gules";
        public const string Pontruwaert = "Azure, an eagle displayed or";
        public const string PontruwaertRousbrugge = "Barry of six argent and azure, a bordure gules";
        public const string Pontruwaert2 = "Per fess argent and gules, in canton an escutcheon barry of six argent and azure, charged with a bordure gules";
        public const string noname2 = "Or, a lion rampant gules armed and langued or, debruised by a bend ermine";
        public const string Platiel = "Argent, an eagle displayed gules";
        public const string AlostPoppenrode = "Azure, a lion rampant or within a bordure gules fretty argent";
        public const string Poppenrode = "Azure, a lion rampant or within a bordure gules fretty argent";
        public const string Oestwinckele = "Per fess paly of seven argent and gules, and vert";
        public const string Oestwincle = "Gules, a fess of five lozenges conjoined and a label argent";
        public const string Oestkerke = "Gules, three crescents argent";
        public const string VoerdeOestkerke = "Gules, three crescents argent";
        public const string Ogierlande = "Gules, two swords [hilts to chief] argent";
        public const string VormiselleOgierlande = "Gules, two swords [hilts to chief] argent";
        public const string Phalippin = "Per fess or and gules";
        public const string LislePhalippin = "Per fess or and gules";
        public const string MortaingneRadoulx_Tournay = "Or, a cross gules";
        public const string NyelleNevele_Radolff_Tournay = "Argent, a cross gules";
        public const string EspireRadolff_Tournay = "Gules, a cross argent";
        public const string GandSouttenghiem = "Quarterly: gyronny of ten or and gules crusilly argent, and sable a chief argent";
        public const string Sottenghiem = "Gyronny of ten or and gules crusilly argent";
        public const string OultreSchore = "Ermine, on a bend gules three escallops or";
        public const string IseghemSchore = "Ermine, on a bend gules in canton a sexfoil pierced argent";
        public const string Vaernewick = "Sable, three lions rampant argent";
        public const string BorstVaernewick = "Sable, three lions rampant argent";
        public const string LarneMoere_Gand_Vilain = "Per fess argent and sable, in canton an escutcheon or charged with a chevron gules";
        public const string LykerkeVilain = "Per fess argent and sable";
        public const string RaseghemVilain = "Per fess argent and sable";
        public const string YpessWeldyne = "Quarterly: gules a saltire argent, and gules, a cross azure billetty or";
        public const string SantbergeWeldyne = "Gules, on a saltire argent a buckle sable";
        public const string Zwevegem = "Or, a lion rampant or outlined sable, debruised by three bends azure, within a bordure compony ermine and gules";
        public const string Zweveghem = "Argent, four chevronels gules";
        public const string Quinghien = "Argent, four chevronels gules";
        public const string RodeQuinghien = "Argent, four chevronels gules";
        public const string Axelles = "Or, a chevron gules";
        public const string Vicht = "Or, fretty sable";
        public const string Herpe = "Argent, a lion rampant gules armed argent within a bordure wavy sable";
        public const string Roustyne = "Sable, a chevron between three escallops argent";
        public const string Wettere = "Gules, a fess vair";
        public const string Baynaerd = "Argent, a double tressure flory-counter-flory vert, overall a chevron gules";
        public const string Brugdamme = "Sable, a fess per fess indented argent and gules";
        public const string Kalkene = "Or, a fess checky argent and sable";
        public const string Couroet = "Or, five bendlets, on a quarter gules a crescent argent";
        public const string Bourst = "Checky or and sable";
        public const string Watendonck = "Azure, a fess vairy argent and gules";
        public const string SeebroucketAroulle = "Argent, three cinquefoils pierced sable";
        public const string Moere = "Azure, a cross moline argent";
        public const string Vormyselle = "Checky argent and gules";
        public const string Haesbrouc = "Gules, on a bend argent three bendlets sable";
        public const string HaesbrouckHauweil = "Gules, a fess of five lozenges conjoined argent";
        public const string DunckerkeChastillon = "Paly of seven gules and azure billetty argent, on a chief or in dexter a lion rampant sable armed and langued gules";
        public const string Stassele = "Gules, a chief or within a bordure wavy azure";
        public const string Bailleul = "Gules, a saltire azure billetty or";
        public const string Berghe = "Checky or and gules";
        public const string MoerbekeSaint_Omer = "Azure crusilly bottonny, a fess or";
        public const string GaymarsouGrymaras = "Argent, a saltire gules";
        public const string Braymont = "Ermine, on a bend gules three eagles displayed or";
        public const string Pienes = "Azure billetty, a fess or";
        public const string Scounez = "Gules, a fess and a label of five points argent";
        public const string Franc = "Checky argent and azure";
        public const string AlostTolline = "Sable, a fess and in chief three ducks naiant argent, an inescutcheon azure charged with a lion rampant or and a bordure gules fretty argent";
        public const string Borre = "Argent, an inescutcheon gules";
        public const string WatervlietdeBergeditdeHautsame = "Or, on a saltire gules five annulets argent";
        public const string RoussynsResins = "Gules, a bend vair";
        public const string VischChapelle = "Argent crusilly bottony, two fish haurient sable";
        public const string Corenhuse = "Gules, a fess embattled-counter-embattled argent";
        public const string Haultain = "Or, a chief gules";
        public const string Herkinghem = "Vair, on a chief gules three hammers argent";
        public const string BoultellierdeFlandres = "Per fess gules and argent, a bend or";
        public const string Winghene = "Azure, an inescutcheon argent overall a bend compony or and gules";
        public const string Bron = "Sable, an inescutcheon argent";
        public const string SainctAulbin = "Per fess gules and or, in canton a cross-crosslet argent";
        public const string Varsenare = "Sable, three swords in fess bendwise argent";
        public const string Tilleghem = "Checky argent and sable";
        public const string Somerghem = "Per fess paly of seven or and gules, and vert";
        public const string Allinghem = "Gules billetty, a chevron or";
        public const string Haye = "Sable, an inescutcheon and in chief two mullets of eight argent";
        public const string Morslede = "Bend of five or and gules";
        public const string HayshoveWalle2 = "Gules, a lioness rampant or";
        public const string SaintBavon = "Or, a fess checky argent and gules";
        public const string Werveke = "Or, a bend between six roses gules, seeded argent, barbed vert";
        public const string Sengne = "Or, a quarter gules";
        public const string Wavre = "Sable, a lion rampant or armed and langued debruised by a bendlet gules";
        public const string Puthem = "Argent, a quarter and two six-petaled roses gules seeded argent barbed vert";
        public const string Isegem = "Argent, a cross between twelve martlets in orle sable";
        public const string Wolmerbeke = "Or billetty, a chevron gules";
        public const string Zwynarde = "Sable, a chevron between three millrinds(?) or";
        public const string Guysnes = "Vairy or and azure, on a bend gules three escallops argent";
        public const string Lauwe = "Quarterly or and sable";
        public const string Clesselare = "Sable, a cross argent";
        public const string Rokeghem = "Or, a double tressure flory counter flory vert, overall a cross gules";
        public const string Overmerree = "Azure, a lion rampant or debruised by a bend gules";
        public const string Donck = "Barry of six gules and or, a bend and overall a bend sinister argent";
        public const string Robais = "Ermine, a chief gules";
        public const string Chochem = "Argent, a lion rampant gules armed and langued or, or a bend azure three hammers or";
        public const string Plusbarcque = "Barry of eight argent and azure";
        public const string Douwye = "Chevronelly or and sable";
        public const string Everghem = "Barry of seven or and gules";
        public const string Lyelare = "Sable, a chevron argent";
        public const string Beverne = "Sable, three bars-gemelle or";
        public const string VedergraleFlamaingdeGand = "Bendy of seven or and azure, a bordure gules";
        public const string Borst = "Azure billetty, a lion rampant or and a bordure wavy argent";
        public const string Belleghemnotatypo = "Chevronelly argent and gules, a bordure argent";
        public const string Arselles = "Or, a chevron gules and a label argent";
        public const string BavicoveBrande = "Bendy of seven argent and sable";
        public const string Bavicove = "Barry of five or and gules";
        public const string HondekerneBetune = "Argent, a fess gules";
        public const string InghelramSemerael = "Gyronny of ten argent and gules, an inescutcheon azure";
        public const string BlanquemaleCourtray = "Ermine, a chevron gules";
        public const string LessinghersMaelstede = "Argent, a fess azure, overall a saltire gules";
        public const string Strate = "Gules, three swords bendwise in fess";
        public const string Symyan = "Checky azure and argent, a bordure gules";
        public const string Cleyhem = "Sable, a saltire argent";
        public const string CleyhemGaliard = "Sable, an inescutcheon sable charged with a saltire and a bordure argent, betw een three plates";
        public const string Daydyselle = "Vert, ten lozenges 3,3,3 and 1 conjoined argent";
        public const string Samyron = "Per pale indented or and azure";
        public const string LokerneBetune = "Argent, a fess gules";
        public const string Saemslacht = "Gules, a cross between twelve martlets or";
        public const string Crombeke = "Or, five bendlets gules and a quarter gules fretty argent";
        public const string Herwin = "Argent, a fess gules and in chief a lion passant vert";
        public const string Schiervelde = "Ermine, a fess of five lozenges gules";
        public const string Moere2 = "Sable, a cross between four martlets argent";
        public const string Hersteyn = "Per fess paly of eight or and gules, and vert";
        public const string Hauterive = "Azure, a lion rampant argent";
        public const string Court = "Argent, a lion rampant gules";
        public const string StGeorgesDistelleHaeyn = "Per fess paly of seven argent and gules, and azure";
        public const string Juede = "Per fess or and azure bezanty";
        public const string Reneghers = "Azure billetty, a bend or";
        public const string Bassevelde = "Or, a cross between twelve martlets in orle sable";
        public const string Berquin = "Or, a bordure gules";
        public const string Mauerepienes = "Azure billetty, on a fess argent three annulets gules";
        public const string JehanGillion = "Gules, two lions rampant addorsed or";
        public const string Baerdonck = "Gules, three axe-blades [with handles] or, that in sinister chief blade to sinister";
        public const string Veysee = "Bendy of five argent and gules, in chief a barrulet dancetty sable";
        public const string CarmuerRycque = "Sable, a lion rampant crowned argent";
        public const string Raysy = "Azure, a cross argent between twelve martlets in orle argent";
        public const string BeaucampSchoonevelde = "Gules, ten escallops 4,3,2, and 1 argent";
        public const string ValeeDerevael = "Argent, a bend of six lozenges sable";
        public const string Roont = "Sable, on a chief or a demi-lion gules";
        public const string GrymarasSchelde = "Argent, a cross moline gules";
        public const string FossesBoeteline = "Argent, on a chevron between three martlets sable, three eagles or";
        public const string Maertres = "Ermine, a cross gules";
        public const string Munte = "Or, a quarter and two lions rampant sable armed gules";
        public const string Rotselare = "Sable, a patriarchal cross argent";
        public const string RicquarertStandaert = "Gules, six roses argent barbed vert";
        public const string CourtVilaindeGand = "Per fess argent and sable, in chief three lion's head gules orbed and langued or";
        public const string noname3 = "Sable, on a chevron argent three cinquefoils gules";
        public const string ValerantDelmy = "Or, a lion rampant sable armed, orbed and langued gules, charged on the breast with an estoile argent";
        public const string Bossche = "Argent, a lion passant guardant gules, orbed and langued argent";
        public const string Spelt = "Sable, six lions rampant argent";
        public const string Papes = "Gules, three cinquefoils pierced argent";
        public const string BauduynRym = "Or, a lion rampant guardant gules orbed and langued argent";
        public const string Helst = "Azure, three eagles displayed argent";
        public const string Moerlinghem = "Chevronelly argent and sable";
        public const string noname4 = "Or, a lion rampant sable armed orbed and langued or, debruised by a bend invected-counter-invected gules";
        public const string HughesdeleHaute = "Barry of six gules and argent, on the chiefmost bar three annulets or";
        public const string Bombacque = "Barry of six argent and azure, a bend gules";
        public const string Rumbeque = "Gules, on a chief argent, a lion passant sable armed orbed and langued or";
        public const string DisteldoncketBourge = "Or, on a chevron gules, three mulllets of eight points argent";
        public const string Aspelare = "Gules, three lions rampant or within a bordure argent";
        public const string Valkyghem = "Barry of five gules and ermine, a bordure ermine";
        public const string Stoerm = "Argent, a cinquefoil pierced gules within a bordure wavy sable";
        public const string Walle3 = "Gules, a lion rampant argent";
        public const string Masserode = "Argent, a chevron gules and a label of four points sable";
        public const string Hautois = "Per fess gules and argent, in dexter chief a martlet argent";
        public const string Lombeque = "Argent, a cross vert";
        public const string Hoyen = "Barry of seven or and gules, a bordure argent";
        public const string Gemmen = "Argent, a fess sable and a label of three points gules";
        public const string Simmersaques = "Argent, an eagle displayed sable";
        public const string Huerne = "Argent, an inescutcheon and in chief three martlets sable";
        public const string Plusdome = "Checky argent and gules, a bend azure";
        public const string Dossemer = "Barry of six gules and or, a label of three points argent";
        public const string Daynse = "Barry of eight argent and gules";
        public const string Lys = "Vair, a chief gules";
        public const string RyuenenTounesys = "Argent, a fess sable";
        public const string Leeuwe = "Argent, a fess gules and in chief a lion passant azure";
        public const string Muer = "Argent, on a cross between twelve martlets in orle sable, five escallops or";
        public const string MoscronLouwain = "Gules, a fess argent";
        public const string MostcronBare = "Gules, on a bend azure five ewers argent";
        public const string Hasselt = "Barry of six sable fretty argent and argent";
        public const string Tournoy = "Azure, a lion rampant or debruised by a bend compony ermine and gules";
        public const string JosseGalle = "Sable, three crescents argent";
        public const string Wincre = "Azure, a lion rampant within a bordure wavy argent";
        public const string Segerscapple = "Barry of five or and gules, a bordure gules";
        public const string Bonneloee = "Quarterly argent and gules, a bend azure";
        public const string Muellyn = "Sable, ten escallops 4,3,2, and 1 argent";
        public const string Haudenhove = "Sable billetty, a bend argent";
        public const string Heryn = "Gules, a chief or fretty sable";
        public const string Melden = "Barry of six gules and argent";
        public const string Crombrugge = "Sable, a fleur-de-lys argent";
        public const string Wulfsberghes = "Gules, ten escallops 4,3,2, and 1 or";
        public const string Waestynes = "Argent, a bordure sable";
        public const string Fletres = "Sable, a cross checky argent and gules, overall a quarter or charged with a lion rampant sable armed and langued gules";
        public const string HerinesMullaert = "Gules, three lions rampant or";
        public const string Steenbeke = "Azure, three escallops argent";
        public const string Racheberch = "Or, three chevronels sable";
        public const string PierreBladelinc = "Ermine, a bend gules doubly fibriated or and gules";
        public const string Pryeaulx = "Or, an eagle displayed gules";
        public const string SchonewalleBouldyns = "Azure, a chevron argent, overall a quarter argent charged witha lion rampant sable armed and langued gules";
        public const string Cocsye = "Gules billetty, a fess argent";
        public const string Rosinbos = "Bendy of six argent and gules";
        public const string Ph = "Argent, a quarter divided quarterly: in 1 and 4, France Ancient within a bordure compony gules and argent; in 2, sable a lion rampant or; in 3, argent a lion rampant gules";
        public const string NederbracleLalaing = "Gules, ten lozenges 3,3,3 and 1 conjoined argent";
        public const string MerlebequeLaChabre = "Sable, a cross checky argent and gules";
        public const string DentelgemZypee = "Vert, three lion's heads cabossed orbed and langued gules";
        public const string Hessenee = "Sable, a chevron argent";
        public const string Ballinquet = "Gules, on a cross between twelve martlets in orle or, five cinquefoils pierced gules";
        public const string Brouckerke = "Argent, on a fess sable three cinquefoils pierced or";
        public const string Mysme = "Argent, on a chevron gules three millrinds (?) or";
        public const string Meerhem = "Argent, on a bend sable three cinquefoils pierced argent";
        public const string NieuenhoveMolenbeke = "Or, a saltire wavy counter wavy azure between four garbs(?) sable, overall a label of two points argent";
        public const string dEstrushuntkerke = "Argent, on a cross sable five escallops or";
        public const string HedeghemGrisperre = "Argent, three chevronels sable";
        public const string Beaufremez = "Azure, an inescutcheon and in chief three martlets argent";
        public const string Corteville = "Quarterly or a cross moline gules, and argent an eagle displayed sable";
        public const string BorstUtenhove = "Argent, three bars-gemelle gules";
        public const string OvermeerreMasmines = "Azure, a lion rampant or within a bordure wavy argent";
        public const string KalkeneMasmines = "Azure, a lion rampant or";
        public const string ExardeGrutere = "Sable, three bars-gemelle or";
        public const string Pereoest = "Per fess or and gules, in chief three mullets of eight points gules";
        public const string RoveryeHameyde = "Argent, three bars couped gules";
        public const string Dessteylles = "Ermine, a fess gules";
        public const string Hassenede = "Sable, a chevron between three boar's heads or orbed gules";
        public const string PlatieulxBergesdeSainctWinnox = "Or, a lion rampant gules armed and langued argent";
        public const string LyelareHerselles = "Gules, three lions rampant or";
        public const string HeyneOnguis = "Vert, a fess ermine";
        public const string TamiseLeFebure = "Or, a sword inverted bendwise between two eagles displayed sable, armed gules";
        public const string Tysse = "Gules fretty or, a fess ermine";
        public const string Ryde = "Per fess gules and or, in chief three escallops or";
        public const string Tramerie = "Sable, a chevron between three martlets or";
        public const string Marglers = "Argent, a fess azure";
        public const string VyessdeLeghem = "Barry of five sable and or";
        public const string HukenghienMasmines = "Azure, a lion rampant or";
        public const string Lauron = "Vert, a cross argent";
        public const string KennoOngnies = "Vert, a fess ermine and in canton a mullet of eight sable";
        public const string Waultre = "Argent, a chevron between ten martlets sable";
        public const string AugenontdAuglemont = "Argent, a chevron between three crosses patty fitchy";
        public const string Waestene = "Argent, a fess gules and in chief a label of five points throughout azure";
        public const string Wedergrate_RegnaudGoes = "Quarterly sable, a lion rampant or, and azure, an eagle displayed or";
        public const string Mailines = "Paly of eight or and gules, on an inescutcheon argent, an eagle displayed sable";
        public const string Momde = "Barry of six gules fretty argent and or";
        public const string Reyghersvliet = "Azure, a cross wavy argent";
        public const string Saeftinghe = "Or, a lion rampant sable orbed or armed and langued gules, within a bordure compony argent and gules";
        public const string Espinoy = "Azure, an eagle displayed argent";
        public const string Urfys = "Argent, an inescutcheon or charged with a lion rampant sable armed and langued gules, within an orle of chain vert";
        public const string Gontre = "Or, a lion rampant sable armed orbed and langued gules within a bordure wavy azure";
        public const string Porz = "Barry of six azure and argent, a bend gules";
        public const string Lembeke = "Per fess or and azure, in chief a lion passant sable armed and langued gules";
        public const string Staeden = "Gules, a chevron or";
        public const string HutkerckeleJosnee = "Argent, on a cross sable five escallops or";
        public const string Bornhem = "Or, a domed tower azure";
        public const string Everghem2 = "Or, a boar passant sable armed and orbed argent";
        public const string Male = "Or, a lion rampant sable armed, orbed and langued gules";
        public const string Winendale_Aroulle_TourroutCleves = "Quarterly, gules an escarbuncle or, and or a fess checky argent and gules, overall an inescutcheon quarterly, France Ancient within a bordure compony argent and gules, and bendy of five or and azure within a bordure gules, overall an inescutcheon or charged with a lion rampant sable armed and langued gules";
        public const string deWyldedeGroote = "Azure, a cross between twelve martlets in orle or";
        public const string Smoers = "Sable, ten escallops 4,3,2, and 1 argent";
        public const string Marque = "Gules, a cross or, in dexter chief an escutcheon sable billetty charged with a crescent argent";
        public const string Tornegnis = "Gules, a fess ermine";
        public const string Weurhoute = "Argent, a saltire gules surmounted by a fess azure";
        public const string Scuellegem = "Gules, six escallops argent";
        public const string Mullem = "Vert, a chevron between three martlets argent";
        public const string Women = "Argent, a saltire gules";
        public const string Vichius = "Argent, three mullets of six points fesswise gules";
        public const string LaHabele = "Argent, three bars couped gules";
        public const string Brackele = "Chevronelly argent and gules";
        public const string Azevegem = "Argent, four chevronels gules";
        public const string Zedelghem = "Or, on a chevron gules, three escallops argent";
        public const string Huce = "Quarterly argent and gules";
        public const string Drinchaem = "Checky argent and azure, a bordure gules";
        public const string BisemontBillemont = "Sable, an inescutcheon argent overall a bend or";
        public const string Baynyermes = "Argent, nine roses gules seeded or barbed vert and a quarter azure charged with an escutcheon argent";
        public const string RobertdeFlandresComtedeCassel = "Or, a lion rampant sable armed orbed and langued gules, a label of three points argent";
        public const string Hauterive2 = "Azure, a lion rampant argent";
        public const string Lylle = "Gules, on a chief or, a demi lion sable armed orbed and langued gules";
        public const string Rely = "Or, three chevronels azure";
        public const string JehanTant = "Gules, a cross moline argent, overall a quarter azure charged with a tower or, its door gules";
        public const string Damman = "Sable crusilly crosslet, a chevron argent";
        public const string Pollare = "Gules, on a saltire argent, five annulets gules";
        public const string PollaredeVoos = "Argent, on a bend sable, three lions rampant or";
        public const string GuillaumedeFlandres_Sr = "Or, a lion rampant sable armed orbed and langued within a bordure gules";
        public const string Tolbins = "Or, a saltire azure, overall a cross wavy argent";
        public const string DAbvil = "Barry of eight gules and argent, a bordure argent";
        public const string Bois = "Argent, a lion rampant sable armed orbed and langued gules";
        public const string BoysdYpre = "Or, a fess vert";
        public const string Verbois = "Sable, a bend of seven lozenges argent";
        public const string RumbekeLonpre = "Gules, a bend embattled-counter-embattled enhanced argent";
        public const string Damme = "Per fess argent and sable, on a bend gules three annulets or";
        public const string Temple = "Azure, a quarter or charged with a lion rampant sable armed orbed and langued gules";
        public const string Hekelsbeque = "Gules, three mullets of eight pierced argent";
        public const string Boure = "Ermine, three mullets of six fesswise gules";
        public const string Westehende = "Azure, a bar argent";
        public const string LevenynLeynyn = "Argent, two lions passant guardant sable";
        public const string Frohuse = "Gules, a fess within a bordure wavy argent";
        public const string Leffinge = "Azure, a saltire between twelve martlets in orle or";
        public const string Winghene2 = "Per fess paly of seven or and gules and vert, in base three mascles argent";
        public const string Croys = "Argent, a cross azure";
        public const string Leeke = "Per fess or, a lion passant gules, and azure, three escallops argent";
        public const string Assebrouc = "Gules, on a bend argent, three eagles diplayed azure";
        public const string Schuervelde = "Argent, a cross gules and a bend azure";
        public const string DenVliet = "Sable, three lozenges argent";
        public const string Raseghem = "Azure, a lion rampant or armed orbed and langued argent";
        public const string Schathille = "Gules, six crescents argent";
        public const string Lenez = "Lozengy or and gules";
        public const string Bernee = "Ermine, a cross moline guls";
        public const string Delven = "Argent, a fess gules and in chief two martlets sable";
        public const string JehanSporkin = "Sable, ten mullets of eight 4,3,2, and 1 vert";
        public const string BaudPlateilditWaghenare = "Or, three wheels sable";
        public const string NevelleFossene = "Gules, three bars-gemelle argent";
        public const string Mote = "Vairy or and azure";
        public const string Coudekerke = "Checky or and gules";
        public const string Bergem = "Argent, a cross sable";
        public const string Mamul = "Or, a quarter bendy argent and gules, and two fleur-de-lys azure";
        public const string Heecaute = "Azure billetty, on a bend or three martlets gules";
        public const string Poul = "Ermine, a bend vert";
        public const string HeecauteGramsberge = "Argent, a saltire gules";
        public const string Haerlay = "Paly of five argent and sable";
        public const string MarkelisMetteneye = "Gules, a chevron argent between three towers or";
        public const string GandVilainsdeFlandres = "Per fess argent and sable, an escarbuncle or";
        public const string BrugesAsbergauwe = "Barry of eight argent and gules, a lion rampant azure armed and langued or";
        public const string Ypres = "Gules, a cross azure billetty argent";
        public const string Waest = "Azure, a turnip argent leaved vert";
        public const string GavreTurphin = "Or, a lion rampant gules armed or within a bordure wavy wable";
        public const string Cassel = "Argent, a sword between two keys, wards to chief and addorsed, sable";
        public const string Bousinghe = "Or, a moor's head and shoulders erased proper";
        public const string Pamoel = "Gules, a fess argent";
        public const string BoesingeBelle = "Or, six bells azure";
        public const string HeykenPotteles = "Or, a cross gules";
        public const string Sycelle = "Argent, a saltire between four cinquefoils pierced gules";
        public const string BergesSt = "Or, a lion rampant gules armed orbed and langued argent";
        public const string PameleGougny = "Quarterly gules, an eagle displayed argent, and barry of six gules and or";
        public const string FurnesStavele = "Ermine, a bend gules";
        public const string Steenhuse = "Or, a lion or outlined sable, debruised by two bends azure, within a bordure compony gules and argent";
        public const string Ingelmonstre = "Or, a deer's head and antlers cabossed gules";
        public const string Caetten = "Barry of six vair and gules";
        public const string AroulleRousselare = "Argent, a patriarchal cross sable";
        public const string Baud = "Ermine, a lion passant guardant gules orbed and langued argent";
        public const string Staden = "Gules, a chevron or";
        public const string Pradelles_SteenbekeKaltenhofer = "Azure, on a bend or a lion passant gules";
