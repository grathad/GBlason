...
{
    /// <summary>
    /// Parse tokens that represent a <see cref="TokenNames.SimpleDivisionBy2Field"/>.
    /// <para>
    ...
    /// <para>
    /// <h3>Grammar:</h3>
    /// <see cref="TokenNames.SimpleDivisionBy2Field"/> := 
    /// (<see cref="TokenNames.Tincture"/> | <see cref="TokenNames.FieldVariation"/>)
    /// <see cref="TokenNames.And"/>. 
    /// (<see cref="TokenNames.Tincture"/> | (<see cref="TokenNames.FieldVariation"/>)
    /// </para>
    /// </summary>
    internal class SimpleDivisionBy2FieldParser : SimpleDivisionParser
    {
        public SimpleDivisionBy2FieldParser(IParserPilot factory = null)
